...
func (x *MongoProxy) Reset() {
	*x = MongoProxy{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mongo_proxy_proto_msgTypes[0]
...
func (*MongoProxy) Descriptor() ([]byte, []int) {
	return file_mongo_proxy_proto_rawDescGZIP(), []int{0}
}
...
var File_mongo_proxy_proto protoreflect.FileDescriptor

var file_mongo_proxy_proto_rawDesc = []byte{
	0x0a, 0x11, 0x6d, 0x6f, 0x6e, 0x67, 0x6f, 0x5f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x70, 0x72,
...
var (
	file_mongo_proxy_proto_rawDescOnce sync.Once
	file_mongo_proxy_proto_rawDescData = file_mongo_proxy_proto_rawDesc
)

func file_mongo_proxy_proto_rawDescGZIP() []byte {
	file_mongo_proxy_proto_rawDescOnce.Do(func() {
		file_mongo_proxy_proto_rawDescData = protoimpl.X.CompressGZIP(file_mongo_proxy_proto_rawDescData)
	})
	return file_mongo_proxy_proto_rawDescData
}

var file_mongo_proxy_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_mongo_proxy_proto_goTypes = []interface{}{
...
var file_mongo_proxy_proto_depIdxs = []int32{
...
func init() { file_mongo_proxy_proto_init() }
func file_mongo_proxy_proto_init() {
	if File_mongo_proxy_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mongo_proxy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mongo_proxy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mongo_proxy_proto_goTypes,
		DependencyIndexes: file_mongo_proxy_proto_depIdxs,
		MessageInfos:      file_mongo_proxy_proto_msgTypes,
	}.Build()
	File_mongo_proxy_proto = out.File
	file_mongo_proxy_proto_rawDesc = nil
	file_mongo_proxy_proto_goTypes = nil
	file_mongo_proxy_proto_depIdxs = nil
}
